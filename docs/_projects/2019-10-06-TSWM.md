...
date: 26 Dec 2019
screenshot:
    src: ./assets/pics/front_cover_tmp.png
description: >
    This Notebook describes the methods used in this project in detail.
links:
    -   title: Source
...
![あとでかっこいい画像に変える](./assets/pics/front_cover_tmp.png)
